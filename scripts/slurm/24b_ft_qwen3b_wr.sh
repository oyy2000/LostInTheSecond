...
#SBATCH -t 08:00:00
#SBATCH -J ft_q3b_wr
#SBATCH -o /ocean/projects/cis250050p/swang47/yang/LostInTheSecond/logs/ft_qwen3b_wr_%j.out
#SBATCH -e /ocean/projects/cis250050p/swang47/yang/LostInTheSecond/logs/ft_qwen3b_wr_%j.err
...
echo "Time:      $(date)"
echo "Task:      Full FT sweep - Qwen2.5-3B base - wait+recompute"
echo "=============================="
