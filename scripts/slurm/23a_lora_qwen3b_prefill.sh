...
#SBATCH -t 08:00:00
#SBATCH -J lora_q3b_pf
#SBATCH -o /ocean/projects/cis250050p/swang47/yang/LostInTheSecond/logs/lora_qwen3b_pf_%j.out
#SBATCH -e /ocean/projects/cis250050p/swang47/yang/LostInTheSecond/logs/lora_qwen3b_pf_%j.err
...
echo "Time:      $(date)"
echo "Task:      LoRA sweep - Qwen2.5-3B base - prefill"
echo "=============================="
