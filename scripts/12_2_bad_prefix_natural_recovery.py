#!/usr/bin/env python3
"""
Bad-prefix natural recovery on HumanEval.
...
Usage:
    python scripts/12_2_bad_prefix_natural_recovery.py \
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--out-dir", default=str(
        PROJECT_ROOT / "results/humaneval_3b_multi_sample/bad_prefix_recovery"))
