#!/usr/bin/env python3
"""
Bad-prefix natural recovery on MATH-500.
...
Usage:
    python scripts/9_2_bad_prefix_natural_recovery.py \
        ...
        --out-dir results/math500_3b_multi_sample/bad_prefix_recovery \
        --n-continuations 32 \
...
def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Bad-prefix natural recovery (MATH-500)")
    ...
    ap.add_argument("--out-dir", default=str(
        PROJECT_ROOT / "results/math500_3b_multi_sample/bad_prefix_recovery"))
